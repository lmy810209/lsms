// ===== 전도 위험 계산 / TOP5 모듈 (복구 버전) =====

console.log("OUTDOOR RISK JS LOADED");
...
function recalcAllTreeRisks() {
  ...
  allTrees.forEach((t, idx) => {
    allTrees[idx] = computeTreeRisk(t);
  });
  window.treeData = allTrees;
}
